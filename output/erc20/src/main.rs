...
pub mod erc20_403 {
    ...
    pub fn checked_add_uint256(mut x: U256, context: &mut Context) -> YulOutput<U256> {
    ...
    pub fn body(context: &mut Context) -> YulOutput<()> {
        let mut _1 = memoryguard(U256::from(0x80u128), context)?;
        ...
        let mut _2 = checked_add_uint256(sload(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, context)?, context)?;
        mstore(U256::from(0x0u128), caller(context)?, context)?;
        mstore(U256::from(0x20u128), U256::from(0x0u128), context)?;
        sstore(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, _2, context)?;
        let mut _3 = mload(U256::from(0x40u128), context)?;
        ...
        let mut _4 = mload(U256::from(0x40u128), context)?;
        let mut _5 = datasize(from_hex("45726332305f3430335f6465706c6f7965640000000000000000000000000000"), context)?;
    ...
    pub mod erc20_403_deployed {
        ...
        pub fn fun_approve(mut var_owner: U256, mut var_spender: U256, mut var_value: U256, context: &mut Context) -> YulOutput<()> {
            let mut _1 = and(var_owner, sub(shl(U256::from(0xa0u128), U256::from(0x1u128), context)?, U256::from(0x1u128), context)?, context)?;
            if iszero(_1, context)? != U256::ZERO {
                let mut memPtr = mload(U256::from(0x40u128), context)?;
            ...
            let mut _2 = and(var_spender, sub(shl(U256::from(0xa0u128), U256::from(0x1u128), context)?, U256::from(0x1u128), context)?, context)?;
            if iszero(_2, context)? != U256::ZERO {
                let mut memPtr_1 = mload(U256::from(0x40u128), context)?;
            ...
            let mut dataSlot = keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?;
        ...
        pub fn fun_transfer(mut var_from: U256, mut var_to: U256, mut var_value: U256, context: &mut Context) -> YulOutput<()> {
            let mut _1 = and(var_to, sub(shl(U256::from(0xa0u128), U256::from(0x1u128), context)?, U256::from(0x1u128), context)?, context)?;
            if iszero(_1, context)? != U256::ZERO {
                let mut memPtr = mload(U256::from(0x40u128), context)?;
                mstore(memPtr, shl(U256::from(0xe5u128), U256::from(0x461bcdu128), context)?, context)?;
                mstore(add(memPtr, U256::from(0x4u128), context)?, U256::from(0x20u128), context)?;
            ...
            let mut _2 = and(var_from, sub(shl(U256::from(0xa0u128), U256::from(0x1u128), context)?, U256::from(0x1u128), context)?, context)?;
            mstore(U256::from(0x0u128), _2, context)?;
            mstore(U256::from(0x20u128), U256::from(0x0u128), context)?;
            let mut _3 = checked_sub_uint256(sload(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, context)?, var_value, context)?;
            mstore(U256::from(0x0u128), _2, context)?;
            mstore(U256::from(0x20u128), U256::from(0x0u128), context)?;
            sstore(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, _3, context)?;
            mstore(U256::from(0x0u128), _1, context)?;
            mstore(U256::from(0x20u128), U256::from(0x0u128), context)?;
            let mut _4 = checked_add_uint256(sload(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, context)?, var_value, context)?;
            mstore(U256::from(0x0u128), _1, context)?;
            mstore(U256::from(0x20u128), U256::from(0x0u128), context)?;
            sstore(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, _4, context)?;
            let mut _5 = mload(U256::from(0x40u128), context)?;
        ...
        pub fn body(context: &mut Context) -> YulOutput<()> {
            ...
            if iszero(lt(calldatasize(context)?, U256::from(0x4u128), context)?, context)? != U256::ZERO {
                ...
                if δ == U256::from(0x95ea7b3u128) {
                    ...
                    let mut value0 = abi_decode_address(context)?;
                    fun_approve(caller(context)?, value0, calldataload(U256::from(0x24u128), context)?, context)?;
                    let mut memPos = mload(U256::from(0x40u128), context)?;
                    ...
                    let mut _1 = sload(U256::from(0x2u128), context)?;
                    let mut memPos_1 = mload(U256::from(0x40u128), context)?;
                    ...
                    let mut value0_1 = abi_decode_address(context)?;
                    let mut value1 = abi_decode_t_address(context)?;
                    let mut value = calldataload(U256::from(0x44u128), context)?;
                    ...
                    let mut memPos_2 = mload(U256::from(0x40u128), context)?;
                    ...
                    let mut value0_2 = abi_decode_address(context)?;
                    mstore(U256::from(0x0u128), caller(context)?, context)?;
                    mstore(U256::from(0x20u128), U256::from(0x1u128), context)?;
                    let mut dataSlot_2 = keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?;
                    ...
                    let mut memPos_3 = mload(U256::from(0x40u128), context)?;
                    ...
                    mstore(U256::from(0x20u128), U256::from(0x0u128), context)?;
                    let mut _2 = sload(keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?, context)?;
                    let mut memPos_4 = mload(U256::from(0x40u128), context)?;
                    ...
                    let mut value0_3 = abi_decode_address(context)?;
                    mstore(U256::from(0x0u128), caller(context)?, context)?;
                    mstore(U256::from(0x20u128), U256::from(0x1u128), context)?;
                    let mut dataSlot_4 = keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?;
                    ...
                    let mut memPos_5 = mload(U256::from(0x40u128), context)?;
                    ...
                    let mut value0_4 = abi_decode_address(context)?;
                    fun_transfer(caller(context)?, value0_4, calldataload(U256::from(0x24u128), context)?, context)?;
                    let mut memPos_6 = mload(U256::from(0x40u128), context)?;
                    ...
                    let mut value0_5 = abi_decode_address(context)?;
                    let mut value1_1 = abi_decode_t_address(context)?;
                    ...
                    mstore(U256::from(0x20u128), U256::from(0x1u128), context)?;
                    let mut dataSlot_6 = keccak256(U256::from(0x0u128), U256::from(0x40u128), context)?;
                    ...
                    let mut _3 = sload(dataSlot_7, context)?;
                    let mut memPos_7 = mload(U256::from(0x40u128), context)?;
