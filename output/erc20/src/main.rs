...
pub mod erc20 {
    ...
    pub fn checked_add_uint256<CI>(x: U256, context: &mut Context<CI>) -> YulOutput<U256>
    where
    ...
    pub mod erc20_deployed {
        ...
        pub fn abi_decode_address<CI>(context: &mut Context<CI>) -> YulOutput<U256>
        where
            Context<CI>: ContractInteractions,
        {
        ...
        pub fn abi_decode_t_address<CI>(context: &mut Context<CI>) -> YulOutput<U256>
        where
            Context<CI>: ContractInteractions,
        {
            let mut value = U256::ZERO;
        ...
        pub fn checked_add_uint256<CI>(x: U256, y: U256, context: &mut Context<CI>) -> YulOutput<U256>
        where
            Context<CI>: ContractInteractions,
        {
            let mut sum = U256::ZERO;
        ...
        pub fn checked_sub_uint256<CI>(x: U256, y: U256, context: &mut Context<CI>) -> YulOutput<U256>
        where
            Context<CI>: ContractInteractions,
        {
        ...
        pub fn fun_approve<CI>(var_owner: U256, var_spender: U256, var_value: U256, context: &mut Context<CI>) -> YulOutput<()>
        where
            Context<CI>: ContractInteractions,
        {
