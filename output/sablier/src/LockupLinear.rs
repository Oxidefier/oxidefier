...
pub mod lockuplinear_6476 {
    ...
    pub fn body(context: &mut Context) -> YulOutput<()> {
        ...
        codecopy(_1, dataoffset(from_hex("4c6f636b75704c696e6561725f363437365f6465706c6f796564000000000000"), context)?, datasize(from_hex("4c6f636b75704c696e6561725f363437365f6465706c6f796564000000000000"), context)?, context)?;
        setimmutable(_1, from_hex("6c6962726172795f6465706c6f795f6164647265737300000000000000000000"), address(context)?, context)?;
        return_(_1, datasize(from_hex("4c6f636b75704c696e6561725f363437365f6465706c6f796564000000000000"), context)?, context)?;
        Ok(())
    }

    pub mod lockuplinear_6476_deployed {
        use alloy_primitives::U256;
        use evm_opcodes::*;
...
fn main() {
    ...
    // let result = lockuplinear_6476::lockuplinear_6476_deployed::fun_runTests(
    //     &mut context
    // );
