...
pub mod lockup_6442 {
    ...
    pub fn body(context: &mut Context) -> YulOutput<()> {
        ...
        codecopy(_1, dataoffset(from_hex("4c6f636b75705f363434325f6465706c6f796564000000000000000000000000"), context)?, datasize(from_hex("4c6f636b75705f363434325f6465706c6f796564000000000000000000000000"), context)?, context)?;
        setimmutable(_1, from_hex("6c6962726172795f6465706c6f795f6164647265737300000000000000000000"), address(context)?, context)?;
        return_(_1, datasize(from_hex("4c6f636b75705f363434325f6465706c6f796564000000000000000000000000"), context)?, context)?;
        Ok(())
    }

    pub mod lockup_6442_deployed {
        use alloy_primitives::U256;
        use evm_opcodes::*;
...
fn main() {
    ...
    // let result = lockup_6442::lockup_6442_deployed::fun_runTests(
    //     &mut context
    // );
