...
pub mod strings_7364 {
    ...
    pub fn body(context: &mut Context) -> YulOutput<()> {
        ...
        codecopy(_1, dataoffset(from_hex("537472696e67735f373336345f6465706c6f7965640000000000000000000000"), context)?, datasize(from_hex("537472696e67735f373336345f6465706c6f7965640000000000000000000000"), context)?, context)?;
        setimmutable(_1, from_hex("6c6962726172795f6465706c6f795f6164647265737300000000000000000000"), address(context)?, context)?;
        return_(_1, datasize(from_hex("537472696e67735f373336345f6465706c6f7965640000000000000000000000"), context)?, context)?;
        Ok(())
    }

    pub mod strings_7364_deployed {
        use alloy_primitives::U256;
        use evm_opcodes::*;
...
fn main() {
    ...
    // let result = strings_7364::strings_7364_deployed::fun_runTests(
    //     &mut context
    // );
