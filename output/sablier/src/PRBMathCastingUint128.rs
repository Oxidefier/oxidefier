...
pub mod prbmathcastinguint128_8217 {
    use alloy_primitives::U256;
    use evm_opcodes::*;
    ...
    pub fn body(context: &mut Context) -> YulOutput<()> {
        ...
        codecopy(_1, dataoffset(from_hex("5052424d61746843617374696e6755696e743132385f383231375f6465706c6f796564"), context)?, datasize(from_hex("5052424d61746843617374696e6755696e743132385f383231375f6465706c6f796564"), context)?, context)?;
        setimmutable(_1, from_hex("6c6962726172795f6465706c6f795f6164647265737300000000000000000000"), address(context)?, context)?;
        return_(_1, datasize(from_hex("5052424d61746843617374696e6755696e743132385f383231375f6465706c6f796564"), context)?, context)?;
        Ok(())
    }

    pub mod prbmathcastinguint128_8217_deployed {
        use alloy_primitives::U256;
        use evm_opcodes::*;
...
fn main() {
    ...
    // let result = prbmathcastinguint128_8217::prbmathcastinguint128_8217_deployed::fun_runTests(
    //     &mut context
    // );
