...
pub mod testopcodes_684 {
    ...
    pub mod testopcodes_684_deployed {
        use alloy_primitives::U256;
        use evm_opcodes::*;
        ...
        pub fn abi_encode_int256(value: U256, pos: U256, context: &mut Context) -> YulOutput<()> {
            mstore(pos, cleanup_int256(value, context)?, context)?;
            Ok(())
        }

        pub fn cleanup_rational_4660_by(value: U256, context: &mut Context) -> YulOutput<U256> {
            let mut cleaned = U256::ZERO;
            cleaned = value;
            Ok(cleaned)
        }

        pub fn cleanup_uint16(value: U256, context: &mut Context) -> YulOutput<U256> {
            let mut cleaned = U256::ZERO;
        ...
        pub fn cleanup_rational_63_by(value: U256, context: &mut Context) -> YulOutput<U256> {
            let mut cleaned = U256::ZERO;
            cleaned = value;
            Ok(cleaned)
        }

        pub fn cleanup_rational_6_by(value: U256, context: &mut Context) -> YulOutput<U256> {
            let mut cleaned = U256::ZERO;
            cleaned = value;
            Ok(cleaned)
        }

        pub fn cleanup_rational_7_by(value: U256, context: &mut Context) -> YulOutput<U256> {
            let mut cleaned = U256::ZERO;
            cleaned = value;
            Ok(cleaned)
        }
        ...
        pub fn cleanup_rational_minus_3_by(value: U256, context: &mut Context) -> YulOutput<U256> {
            let mut cleaned = U256::ZERO;
            cleaned = value;
            Ok(cleaned)
        }
        ...
        pub fn fun_testAdd(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
        ...
        pub fn fun_testAnd(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testByte(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testCalldatasize(context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testDiv(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testEq(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testExp(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testGas(context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testGt(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testIszero(var_x: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn zero_value_for_split_bytes32(context: &mut Context) -> YulOutput<U256> {
            let mut ret = U256::ZERO;
            ret = U256::from(0x0u128);
            Ok(ret)
        }

        pub fn fun_testKeccak256(var_data_mpos: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
        ...
        pub fn fun_testLt(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testMload(var_x: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testMod(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testMstore(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<()> {
            mstore(var_x, var_y, context)?;
            Ok(())
        }

        pub fn fun_testMstore8(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<()> {
            mstore8(var_x, var_y, context)?;
            Ok(())
        }

        pub fn fun_testMul(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testNot(var_x: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testOr(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testSar(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
        ...
        pub fn fun_testSdiv(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
        ...
        pub fn fun_testSgt(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testShl(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testShr(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testSlt(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_testSmod(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_int256 = zero_value_for_split_int256(context)?;
            var_result = zero_int256;
        ...
        pub fn fun_testSub(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
        ...
        pub fn fun_testXor(var_x: U256, var_y: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
        ...
        pub fn fun_runTests(context: &mut Context) -> YulOutput<()> {
        ...
        pub fn fun_testCalldataload(var_x: U256, context: &mut Context) -> YulOutput<U256> {
            let mut var_result = U256::ZERO;
            let zero_uint256 = zero_value_for_split_uint256(context)?;
            var_result = zero_uint256;
